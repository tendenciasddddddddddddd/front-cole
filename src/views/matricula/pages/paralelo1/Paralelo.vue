            ...
            <div v-if="filtros.length" >
              <div class="row mt-3" >
                <div class="col-lg-6 "  >
                  ...
                  <ag-grid-vue style="width: 100%; height: 400px;" class="ag-theme-alpine" :defaultColDef="defaultColDef"
                ...
                <div class="col-lg-6 ">
                  ...
                  <ag-grid-vue style="width: 100%; height: 400px;" class="ag-theme-alpine mt-3"
