<template>
  <div>
      ...
      <div class="col-lg-12 col-12 mx-auto">
        <div class="row">
          ...
          <div v-else class="col-lg-5">
            ...
            <form @submit.prevent="save" id="pefilD">
              <div class="row mt-3">
                <div class="col-sm-12">
                  ...
                  <input :class="{ error: validation.hasError('model.nombres') }"
                    class="form-control buscador fuente mt-1" type="text" v-model="model.nombres" @input="OnEdit" />
                ...
                <div class="col-sm-12 mt-3">
                  ...
                  }" class="form-control buscador fuente mt-1" type="text" v-model="model.apellidos"
                    @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
                ...
                <div class="col-sm-12 mt-3">
                  ...
                  }" class="form-control buscador fuente mt-1" type="text" v-model="model.email" @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
              ...
              <div class="row mt-3">
                <div class="col-sm-6 ">
                  ...
                  }" class="form-control buscador fuente mt-1" type="text" v-model="model.fkparroquia"
                    @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
                ...
                <div class="col-sm-6 ">
                  ...
                  <input :class="{ error: validation.hasError('model.fketnia') }"
                    class="form-control buscador fuente mt-1" type="text" v-model="model.fketnia" @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
              ...
              <div class="row mb-3">
                <div class="col-sm-12 mt-3">
                  ...
                  }" class="form-control buscador fuente mt-1" type="text" v-model="model.telefono"
                    @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
                ...
                <div class="col-sm-12 mt-2">
                  ...
                  <input :class="{ error: validation.hasError('model.sexo') }" class="form-control buscador fuente mt-1"
                    type="text" v-model="model.sexo" @input="OnEdit" />
                  <p class="mb-0 text-sm text-danger">
            ...
            <button v-if="ifLoad" class="w-100 btn btnNaranja" type="button" disabled>
              <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
              Enviando...
            </button>
            <button v-else type="submit" class="w-100  btn-vercel" form="pefilD">
              Guardar Información
            </button>
            <br> <br> <br>
          </div>
    ...
    <div class="fixed-plugin" :class="{ 'show reponv1': tabla === 'perfiles' }">
      <div class="card shadow-lg desplega" :class="{ reponv1: tabla === 'perfiles' }"
        style="overflow-y: auto; z-index: 9999; ">
        <div class=" cabesa" style="margin-left:-20px; margin-right: -10px; border-radius: 0; min-height: 58px;
         padding: 4px 25px 4px 40px;">
          ...
          <div class="float-end mt-2">
            <button @click="tabla = 'termina'" class="btn btn-link text-dark p-0 fixed-plugin-close-button">
        ...
        <div class="card-body pt-sm-3 pt-0" style="overflow-y: auto;height: auto;">
          ...
          <div class="row">
            ...
            <div v-else class="mt-3">
              <span style="cursor: pointer;" class="button fuente tamanio links" @click="$refs.file.click()">
                <input type="file" class="btn btnNaranja" ref="file" @change="uploadImage($event)" accept="image/*" />
                <b>Elegir una foto</b>
              </span>
        ...
        <div class="cord-footer modalFooter" style="">
          <div class="text-end">
            <a @click="tabla = 'termina'" class="btn btnNaranjaClaro">Cancelar</a>

            <button v-if="!isFile" class="btn btnDisabled ms-3">
              Guardar
            </button>
            <template v-else>
              <button v-if="isImageUploads" class="btn btnNaranja ms-3" type="button" disabled>
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                Trabajando...
              </button>
